...
class Calculator extends React.Component{
    ...
    reset(){//resetting the calculator
        this.setState({
            userInput: '0',
            output: '0',
        });
    ...
    displayNumber(value){
        ...
        if(/(^[1-9]|^0\.|^[1-9][0-9]*\.)[0-9]*$/.test(this.state.userInput + value)){
            this.setState( state => ({
        ...
        else if("/*-+".includes(this.state.userInput) && "0123456789".includes(value)){
            this.setState( state => ({
                userInput: value,
                output: state.output + value,
            }));
    ...
    render(){
        ...
        return (
            <div className="calculator-wrapper">
                ...
                <div id="display" className="user-input label">{this.state.userInput}</div>
                <input type="button" value="AC" id="clear" onClick={this.handleClick}/>
                <input type="button" value="/" id="divide" onClick={this.handleClick} className="operator"/>
                <input type="button" value="*" id="multiply" onClick={this.handleClick} className="operator" />
                ...
                <input type="button" value="-" id="subtract" onClick={this.handleClick} className="operator"/>
                ...
                <input type="button" value="+" id="add" onClick={this.handleClick} className="operator"/>
                ...
                <input type="button" value="." id="decimal" onClick={this.handleClick} />
