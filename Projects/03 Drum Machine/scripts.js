        ...
        <div className="drum-pads left-div">
          <span className="drum-pad" id="Heater-1" onClick={this.handleClick}>
            <audio
              ...
              id="Q"
              type="audio/mp3"
              src={audioURL.Q[this.state.index]}
            ></audio>
            Q
          </span>
          <span className="drum-pad" id="Heater-2" onClick={this.handleClick}>
            <audio
              ...
              id="W"
              type="audio/mp3"
              src={audioURL.W[this.state.index]}
            ></audio>
            W
          </span>
          <span className="drum-pad" id="Heater-3" onClick={this.handleClick}>
            <audio
              ...
              id="E"
              type="audio/mp3"
              src={audioURL.E[this.state.index]}
            ></audio>
            E
          </span>
          <span className="drum-pad" id="Heater-4" onClick={this.handleClick}>
            <audio
              ...
              id="A"
              type="audio/mp3"
              src={audioURL.A[this.state.index]}
            ></audio>
            A
          </span>
          <span className="drum-pad" id="Heater-6" onClick={this.handleClick}>
            <audio
              ...
              id="S"
              type="audio/mp3"
              src={audioURL.S[this.state.index]}
            ></audio>
            S
          </span>
          <span className="drum-pad" id="Dsc-Oh" onClick={this.handleClick}>
            <audio
              ...
              id="D"
              type="audio/mp3"
              src={audioURL.D[this.state.index]}
            ></audio>
            D
          </span>
          <span className="drum-pad" id="Kick-n-Hat" onClick={this.handleClick}>
            <audio
              ...
              id="Z"
              type="audio/mp3"
              src={audioURL.Z[this.state.index]}
            ></audio>
            Z
          </span>
          <span className="drum-pad" id="RP4-KICK-1" onClick={this.handleClick}>
            <audio
              ...
              id="X"
              type="audio/mp3"
              src={audioURL.X[this.state.index]}
            ></audio>
            X
          </span>
          <span className="drum-pad" id="Cev_H2" onClick={this.handleClick}>
            <audio
              ...
              id="C"
              type="audio/mp3"
              src={audioURL.C[this.state.index]}
            ></audio>
            C
          </span>
        </div>
